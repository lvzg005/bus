...
<body>
	...
	<pack:script src="rgroup_create.js" />
		...
		<div class="control-group span2.2">
			...
			<div class="controls">
				<div class="input-prepend">
					...
					<input name="rRoles" type="hidden" value='<%=JsonUtils.list2JsonString((List)(request.getAttribute("rRoles")))%>'/>
					<input name="fRoles" type="hidden" value='<%=JsonUtils.list2JsonString((List)(request.getAttribute("fRoles")))%>'/>
				</div>
			</div>
		</div>
	</div>
