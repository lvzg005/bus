...
<body>
	...
	<pack:script src="rgroup_update.js" />
		...
		<div class="control-group span2.2">
			...
			<div class="controls">
				<div class="input-prepend">
					...
					<input id="fcandidate_resources" type="hidden" value='<%=JsonUtils.list2JsonString((List)(request.getAttribute("fcandidate_resources")))%>'/>
					<input id="fselected_resources" type="hidden" value='<%=JsonUtils.list2JsonString((List)(request.getAttribute("fselected_resources")))%>'/>
					<input id="rcandidate_resources" type="hidden" value='<%=JsonUtils.list2JsonString((List)(request.getAttribute("rcandidate_resources")))%>'/>
					<input id="rselected_resources" type="hidden" value='<%=JsonUtils.list2JsonString((List)(request.getAttribute("rselected_resources")))%>'/>
				</div>
			</div>
		</div>
	</div>
