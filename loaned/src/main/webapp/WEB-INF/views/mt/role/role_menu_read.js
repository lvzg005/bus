						...
						customOperationConfig : [
							...
							//跳转到编辑
							{
								...
								action : function(table, selectedData){
									...
									$("form").append("<input type='hidden' name='roleId' value='"+ selectedData[0].col1 +"'/>");
									$("form").append("<input type='hidden' name='roleName' value='"+ selectedData[0].col3 +"'/>");
									$("form").submit();
								}
							}
